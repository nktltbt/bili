...
//		    -------------------  Progress bar -------------------------
	...
	new Thread(new Runnable() {
		  public void run() {	
			...
			DbValeur val = new DbValeur(FormDownload.this);
			val.open();
			String s="";
		...
		if (progressBarStatus >= 100) {
			...
			Intent bindIntent = new Intent(FormDownload.this, ServiceCollecte.class);
			startService(bindIntent);
			// retour à l'accueil
			Intent intent = new Intent(FormDownload.this, MainActivity.class);
