...
public class ValeurNonConnect extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		parametredb.open();
		DbValeur localDbValeurUnit = new DbValeur(this);
		...
		if (curelement.getCount() > 0) { // s'il y a pas de champ
			...
			while (curelement.isAfterLast() == false) {
				...
				Cursor localCursor2 = localDbValeurUnit.getValeursindice(
						idElement, indice);
	...
	public void onClick(View v) {
		...
		case -1: // action bouton retour
			finish();
			Intent retour = new Intent(this, ListValeur.class);
		...
		case 1: // action bouton enregistrer
			...
			enregistrer.putExtra("version", 1);
