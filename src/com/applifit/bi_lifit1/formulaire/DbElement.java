...
public void insertElement(int id, String type, int position_x, int position_y, int idForm){
	...
	public Cursor getElements(int idForm) {
	  ...
	  public Cursor getElementsid(int paramInt)
	  {
	    return this.dbsql.query("element", new String[] { "id", "type", "position_x", "position_y", "idFormulaire" }, "id = " + paramInt, null, null, null, null);
	  }
