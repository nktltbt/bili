...
public class DbAdapter extends SQLiteOpenHelper{
	...
	private static final String DataBase_name="BilifitDBte2.db";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		// la table valeur
				db.execSQL(" create table valeur(" +
						"id integer primary key autoincrement, valeur text, idElement integer, idUser integer, date text, indice integer, version integer);");
		// la table optionsApp
